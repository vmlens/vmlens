...
object  StampedLockExitEventGenInterleave 
{
...
class SortOrigStampedLockExitEventGenInterleave extends Comparator[StampedLockExitEventGenInterleave]
{
...
class SortStampedLockExitEventGenInterleave extends Comparator[StampedLockExitEventGenInterleave]
{
    def	compare(o1 :  StampedLockExitEventGenInterleave,  o2 : StampedLockExitEventGenInterleave ) =
    {
        if( o1.order != o2.order )
