...
class StampedLockEnterEventGenInterleave (
  val threadId  : Long
...
)    extends StampedLockEnterInterleave 
{
override def toString() = {
  var text =  "StampedLockEnterEventGenInterleave" 
...
visitor.visit(this);
 ...
 override def equals(other: Any) = {
    other match {
      case that: StampedLockEnterEventGenInterleave => 
        {
...
object  StampedLockEnterEventGenInterleave 
{

   def applyFromJavaEvent(data : ByteBuffer) =
   {
     val result = new StampedLockEnterEventGenInterleave (
...
class SortOrigStampedLockEnterEventGenInterleave extends Comparator[StampedLockEnterEventGenInterleave]
{
    def	compare(o1 :  StampedLockEnterEventGenInterleave,  o2 : StampedLockEnterEventGenInterleave ) =
    {
...
class SortStampedLockEnterEventGenInterleave extends Comparator[StampedLockEnterEventGenInterleave]
{
    def	compare(o1 :  StampedLockEnterEventGenInterleave,  o2 : StampedLockEnterEventGenInterleave ) =
    {
