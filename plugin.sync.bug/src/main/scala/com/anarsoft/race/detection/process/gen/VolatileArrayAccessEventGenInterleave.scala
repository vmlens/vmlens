...
object  VolatileArrayAccessEventGenInterleave 
{
...
class SortOrigVolatileArrayAccessEventGenInterleave extends Comparator[VolatileArrayAccessEventGenInterleave]
{
...
class SortVolatileArrayAccessEventGenInterleave extends Comparator[VolatileArrayAccessEventGenInterleave]
{
    def	compare(o1 :  VolatileArrayAccessEventGenInterleave,  o2 : VolatileArrayAccessEventGenInterleave ) =
    {
