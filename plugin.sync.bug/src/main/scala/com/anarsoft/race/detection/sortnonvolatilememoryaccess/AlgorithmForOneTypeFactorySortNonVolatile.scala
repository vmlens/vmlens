...
(val partialOrder: PartialOrder, val reportBuilder: RunReportForNonVolatileMemoryAccessBuilder)
  extends AlgorithmForOneTypeFactory[EVENT] {

  override def create(): AlgorithmForOneType[EVENT] = {
    new AlgorithmForOneTypeSortNonVolatile[EVENT](partialOrder, reportBuilder);
  }
