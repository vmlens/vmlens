...
class ArrayAccessEventGenInterleave (
  val threadId  : Long
...
override def toString() = {
  var text =  "ArrayAccessEventGenInterleave" 
...
visitor.visit(this);
 ...
 override def equals(other: Any) = {
    other match {
      case that: ArrayAccessEventGenInterleave => 
        {
...
object  ArrayAccessEventGenInterleave 
{

   def applyFromJavaEvent(data : ByteBuffer) =
   {
     val result = new ArrayAccessEventGenInterleave (
...
class SortOrigArrayAccessEventGenInterleave extends Comparator[ArrayAccessEventGenInterleave]
{
    def	compare(o1 :  ArrayAccessEventGenInterleave,  o2 : ArrayAccessEventGenInterleave ) =
    {
...
class SortArrayAccessEventGenInterleave extends Comparator[ArrayAccessEventGenInterleave]
{
    def	compare(o1 :  ArrayAccessEventGenInterleave,  o2 : ArrayAccessEventGenInterleave ) =
    {
        if( o1.objectHashCode != o2.objectHashCode )
