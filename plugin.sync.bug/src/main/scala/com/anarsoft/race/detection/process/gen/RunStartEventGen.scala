...
class SortOrigRunStartEventGen extends Comparator[RunStartEventGen]
{
    def	compare(o1 :  RunStartEventGen,  o2 : RunStartEventGen ) =
    {
          {
            0;
          }
...
class SortRunStartEventGen extends Comparator[RunStartEventGen]
{
    def	compare(o1 :  RunStartEventGen,  o2 : RunStartEventGen ) =
    {
          {
