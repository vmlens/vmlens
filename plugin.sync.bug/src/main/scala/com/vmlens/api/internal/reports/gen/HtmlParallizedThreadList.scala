...
object $_scalate_$htmlParallizedThreadList_mustache {
...
class $_scalate_$htmlParallizedThreadList_mustache extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$htmlParallizedThreadList_mustache.$_scalate_$render(context)
}
