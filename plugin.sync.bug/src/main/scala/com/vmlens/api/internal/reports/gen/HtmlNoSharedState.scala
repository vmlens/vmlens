...
object $_scalate_$htmlNoSharedState_mustache {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ;{
      ...
      $_scalate_$_context << ( "\">\n \n<p>No shared state available. <a href=\"" )
      $_scope_1.renderVariable("apacheRoot", false)
      $_scalate_$_context << ( "/help/manual/#no-shared-state\">See  here</a> for more information and possible solutions.</p> \n \n \n \n </div>\n\n\n\n\n" )
...
class $_scalate_$htmlNoSharedState_mustache extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$htmlNoSharedState_mustache.$_scalate_$render(context)
}
