...
object $_scalate_$htmlSharedState_mustache {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ;{
      ...
      $_scalate_$_context << ( "\n\n\n<!--  htmlSharedState.mustache -->\n\n<div class=\"" )
      $_scope_1.renderVariable("containerTyp", false)
      $_scalate_$_context << ( "\">\n \n" )
      $_scope_1.partial("methodWithSharedStateTable")
      $_scalate_$_context << ( "\n\n</div>\n\n\n\n\n" )
...
class $_scalate_$htmlSharedState_mustache extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$htmlSharedState_mustache.$_scalate_$render(context)
}
