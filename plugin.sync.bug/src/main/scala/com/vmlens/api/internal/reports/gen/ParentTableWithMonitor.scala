...
object $_scalate_$parentTableWithMonitor_mustache {
  def $_scalate_$render($_scalate_$_context: _root_.org.fusesource.scalate.RenderContext): Unit = {
    ;{
      ...
      $_scope_1.section("issues") { $_scope_2 =>
        ...
        $_scalate_$_context << ( "</td>\r\n   \r\n<td>\r\n" )
        $_scope_2.section("methodContainsMonitor") { $_scope_7 =>
          $_scalate_$_context << ( "<strong>Yes</strong>\r\n" )
        }
        $_scope_2.invertedSection("methodContainsMonitor") { $_scope_8 =>
...
class $_scalate_$parentTableWithMonitor_mustache extends _root_.org.fusesource.scalate.Template {
  def render(context: _root_.org.fusesource.scalate.RenderContext): Unit = $_scalate_$parentTableWithMonitor_mustache.$_scalate_$render(context)
}
