...
import com.vmlens.codeGenerator.domain.EventDesc.{bytecodePosition, barrierType, methodCounter, methodId, nextId, objectHashCode, plusInterleaveFields, threadIndex}
