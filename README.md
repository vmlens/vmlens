...
dependencies {
    testImplementation("com.vmlens:api:1.2.21")
    ...
}
buildscript {
    repositories {
    ...
    dependencies {
        classpath("com.vmlens:standalone:1.2.21")
    }
}
...
1. Include com.vmlens.api from the [Maven Repository](https://repo1.maven.org/maven2/com/vmlens/api/1.2.21/) as a test jar in your project.
1. Download the jar standalone-1.2.21.jar from the [Maven Repository](https://repo1.maven.org/maven2/com/vmlens/standalone/1.2.21/) 
1. Run java -jar standalone-1.2.21.jar install. This creates the agent directory and prints the vm parameter to System.out
1. Add this vm parameter when you run your test
2. Run java -jar standalone-1.2.21.jar report. This checks for data races and creates the report
