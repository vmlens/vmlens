...
)    extends BarrierGetStateEvent  
{
override def toString : String = {
  var text =  "BarrierGetStateEventGen" 
...
override def equals(other: Any) : Boolean = {
    other match {
      case that: BarrierGetStateEventGen => 
        {
...
object  BarrierGetStateEventGen 
{
   def applyFromJavaEvent(data : DataInputStream) =
   {
     val result = new BarrierGetStateEventGen (
