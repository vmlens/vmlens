...
class BarrierWaitEnterEventGen (
   val threadIndex  : Int  
...
)    extends BarrierWaitEnterEvent
{
override def toString : String = {
  var text =  "BarrierWaitEnterEventGen" 
...
override def equals(other: Any) : Boolean = {
    other match {
      case that: BarrierWaitEnterEventGen => 
        {
...
object  BarrierWaitEnterEventGen 
{
   def applyFromJavaEvent(data : DataInputStream) =
   {
     val result = new BarrierWaitEnterEventGen (
