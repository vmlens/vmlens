...
class GetLockStateEventGen (
 ...
 ,  val runId  : Int  
 ,  val runPosition  : Int  
)    extends GetLockStateEvent
{
override def toString : String = {
  var text =  "GetLockStateEventGen" 
...
override def equals(other: Any) : Boolean = {
    other match {
      case that: GetLockStateEventGen => 
        {
...
object  GetLockStateEventGen 
{
   def applyFromJavaEvent(data : DataInputStream) =
   {
     val result = new GetLockStateEventGen (
