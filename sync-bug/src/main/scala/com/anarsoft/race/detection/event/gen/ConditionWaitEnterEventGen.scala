...
class ConditionWaitEnterEventGen (
   val threadIndex  : Int  
...
)    extends ConditionWaitEnterEvent  
{
override def toString : String = {
  var text =  "ConditionWaitEnterEventGen" 
...
override def equals(other: Any) : Boolean = {
    other match {
      case that: ConditionWaitEnterEventGen => 
        {
...
object  ConditionWaitEnterEventGen 
{
   def applyFromJavaEvent(data : DataInputStream) =
   {
     val result = new ConditionWaitEnterEventGen (
