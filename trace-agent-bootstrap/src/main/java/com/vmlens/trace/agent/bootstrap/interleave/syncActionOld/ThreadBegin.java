...
public class ThreadBegin implements EitherPart<ThreadBegin,ThreadStart>, SyncAction {
    ...
    public void createOrderLeft(Position myPosition, ThreadBegin other, Position otherPosition,
        ...
        alternatingOrderElements.add(new TLinkableWrapper<AlternatingOrderElementOld>(
                new AlternatingOrderElementOld(new LeftBeforeRightOld(myPosition, otherPosition))));
    }
    ...
    @Override
    public void createBlock(Position position, boolean moreThanOneThread, DeadlockAndLockContext deadlockAndLockContext,
