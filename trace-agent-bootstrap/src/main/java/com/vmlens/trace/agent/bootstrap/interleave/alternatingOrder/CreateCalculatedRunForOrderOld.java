...
public class CreateCalculatedRunForOrderOld {


    private final int[] length;
    private final TLinkedList<TLinkableWrapper<LeftBeforeRightOld>> order;

    public CreateCalculatedRunForOrderOld(TLinkedList<TLinkableWrapper<LeftBeforeRightOld>> order, int[] length) {
    ...
    private void take(Position position) {
        ...
        Iterator<TLinkableWrapper<LeftBeforeRightOld>> iterator = order.iterator();
        while (iterator.hasNext()) {
            TLinkableWrapper<LeftBeforeRightOld> current = iterator.next();
    ...
    private boolean isFree(Position position) {
        for(TLinkableWrapper<LeftBeforeRightOld> leftBeforeRight : order) {
