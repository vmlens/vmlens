...
public class ConditionWaitExitEvent extends ConditionWaitExitEventGen  implements LockEvent  {

    private final LockType lockTypeClass;
    private Object object;

    public ConditionWaitExitEvent(LockType lockTypeClass, Object object) {
    ...
    public InterleaveAction create(CreateInterleaveActionContext context) {
        return new ConditionWaitExit(this.threadIndex, lockTypeClass.create(objectHashCode));
    }
