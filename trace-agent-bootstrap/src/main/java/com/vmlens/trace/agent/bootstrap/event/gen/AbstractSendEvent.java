...
public abstract class AbstractSendEvent implements SendEvent {
    ...
    public void writeFieldAccessEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(FieldAccessEventGen.class)) {
            getQueueCollection().put(ID_Field, EventFactory.createFieldAccessEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , fieldId
                    , methodCounter
            ...
            getQueueCollection().put(ID_Field, EventFactory.createFieldAccessEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , fieldId
                    , methodCounter
    ...
    public void writeFieldAccessEventStaticGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(FieldAccessEventStaticGen.class)) {
            getQueueCollection().put(ID_Field, EventFactory.createFieldAccessEventStaticGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , fieldId
                    , methodCounter
            ...
            getQueueCollection().put(ID_Field, EventFactory.createFieldAccessEventStaticGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , fieldId
                    , methodCounter
    ...
    public void writeArrayAccessEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(ArrayAccessEventGen.class)) {
            getQueueCollection().put(ID_Field, EventFactory.createArrayAccessEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , fieldId
                    , methodCounter
            ...
            getQueueCollection().put(ID_Field, EventFactory.createArrayAccessEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , fieldId
                    , methodCounter
    ...
    public void writeVolatileAccessEventStaticGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(VolatileAccessEventStaticGen.class)) {
            getQueueCollection().put(ID_SyncActions, EventFactory.createVolatileAccessEventStaticGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , fieldId
            ...
            getQueueCollection().put(ID_SyncActions, EventFactory.createVolatileAccessEventStaticGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , fieldId
    ...
    public void writeVolatileAccessEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(VolatileAccessEventGen.class)) {
            getQueueCollection().put(ID_SyncActions, EventFactory.createVolatileAccessEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , fieldId
            ...
            getQueueCollection().put(ID_SyncActions, EventFactory.createVolatileAccessEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , fieldId
    ...
    public void writeVolatileArrayAccessEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(VolatileArrayAccessEventGen.class)) {
            getQueueCollection().put(ID_SyncActions, EventFactory.createVolatileArrayAccessEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , index
            ...
            getQueueCollection().put(ID_SyncActions, EventFactory.createVolatileArrayAccessEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , index
    ...
    public void writeVolatileDirectMemoryEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_DirectMemory, EventFactory.createVolatileDirectMemoryEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , methodCounter
                    , objectHashCode
    ...
    public void writeLockEnterEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(LockEnterEventGen.class)) {
            getQueueCollection().put(ID_SyncActions, EventFactory.createLockEnterEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
            ...
            getQueueCollection().put(ID_SyncActions, EventFactory.createLockEnterEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
    ...
    public void writeLockExitEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(LockExitEventGen.class)) {
            getQueueCollection().put(ID_SyncActions, EventFactory.createLockExitEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
            ...
            getQueueCollection().put(ID_SyncActions, EventFactory.createLockExitEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
    ...
    public void writeStampedLockEnterEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(StampedLockEnterEventGen.class)) {
            getQueueCollection().put(ID_SyncActions, EventFactory.createStampedLockEnterEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
            ...
            getQueueCollection().put(ID_SyncActions, EventFactory.createStampedLockEnterEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
    ...
    public void writeStampedLockExitEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(StampedLockExitEventGen.class)) {
            getQueueCollection().put(ID_SyncActions, EventFactory.createStampedLockExitEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
            ...
            getQueueCollection().put(ID_SyncActions, EventFactory.createStampedLockExitEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
    ...
    public void writeMonitorEnterEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(MonitorEnterEventGen.class)) {
            getQueueCollection().put(ID_Monitor, EventFactory.createMonitorEnterEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
            ...
            getQueueCollection().put(ID_Monitor, EventFactory.createMonitorEnterEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
    ...
    public void writeMonitorExitEventGen(final int slidingWindowId
        ...
        if (parallizedThreadFacade != null && parallizedThreadFacade.sendAsInterleaveEvent(MonitorExitEventGen.class)) {
            getQueueCollection().put(ID_Monitor, EventFactory.createMonitorExitEventGenInterleave(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
            ...
            getQueueCollection().put(ID_Monitor, EventFactory.createMonitorExitEventGen(slidingWindowId
                    , threadId()
                    , programCounter
                    , order
                    , monitorId
    ...
    public void writeMethodEnterEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createMethodEnterEventGen(slidingWindowId
                    , threadId()
                    , methodId
                    , methodCounter
            ), slidingWindowId);
    ...
    public void writeMethodExitEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createMethodExitEventGen(slidingWindowId
                    , threadId()
                    , methodId
                    , methodCounter
            ), slidingWindowId);
    ...
    public void writeParallizedMethodEnterEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createParallizedMethodEnterEventGen(slidingWindowId
                    , threadId()
                    , methodId
                    , methodCounter
                    , parallizeId
    ...
    public void writeParallizedMethodExitEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createParallizedMethodExitEventGen(slidingWindowId
                    , threadId()
                    , methodId
                    , methodCounter
            ), slidingWindowId);
    ...
    public void writeMethodEnterSmallThreadIdEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createMethodEnterSmallThreadIdEventGen(slidingWindowId
                    , smallThreadId
                    , methodId
                    , methodCounter
            ), slidingWindowId);
    ...
    public void writeMethodExitSmallThreadIdEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createMethodExitSmallThreadIdEventGen(slidingWindowId
                    , smallThreadId
                    , methodId
                    , methodCounter
            ), slidingWindowId);
    ...
    public void writeMethodEnterShortThreadIdEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createMethodEnterShortThreadIdEventGen(slidingWindowId
                    , shortThreadId
                    , methodId
                    , methodCounter
            ), slidingWindowId);
    ...
    public void writeMethodExitShortThreadIdEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Method, EventFactory.createMethodExitShortThreadIdEventGen(slidingWindowId
                    , shortThreadId
                    , methodId
                    , methodCounter
            ), slidingWindowId);
    ...
    public void writeThreadBeginEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_SyncActions, EventFactory.createThreadBeginEventGen(slidingWindowId
                    , threadId()
                    , startedThreadId
                    , programCounter
                    , methodCounter
    ...
    public void writeThreadStoppedEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_SyncActions, EventFactory.createThreadStoppedEventGen(slidingWindowId
                    , threadId()
                    , stoppedThreadId
                    , programCounter
                    , methodCounter
    ...
    public void writeMethodAtomicEnterEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createMethodAtomicEnterEventGen(slidingWindowId
                    , threadId()
                    , methodId
                    , methodCounter
                    , hasCallback
    ...
    public void writeMethodAtomicExitEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createMethodAtomicExitEventGen(slidingWindowId
                    , threadId()
                    , methodId
                    , methodCounter
                    , hasCallback
    ...
    public void writeMethodCallbackEnterEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createMethodCallbackEnterEventGen(slidingWindowId
                    , threadId()
                    , methodCounter
                    , loopId
                    , runId
    ...
    public void writeMethodCallbackExitEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createMethodCallbackExitEventGen(slidingWindowId
                    , threadId()
                    , methodCounter
                    , loopId
                    , runId
    ...
    public void writeLoopStartEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createLoopStartEventGen(slidingWindowId
                    , loopId
            ), slidingWindowId);
        }
    }
    ...
    public void writeLoopEndEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createLoopEndEventGen(slidingWindowId
                    , loopId
                    , status
            ), slidingWindowId);
        }
    ...
    public void writeRunStartEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createRunStartEventGen(slidingWindowId
                    , loopId
                    , runId
            ), slidingWindowId);
        }
    ...
    public void writeRunEndEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createRunEndEventGen(slidingWindowId
                    , loopId
                    , runId
            ), slidingWindowId);
        }
    ...
    public void writeLoopWarningEventGen(final int slidingWindowId
        ...
        {
            getQueueCollection().put(ID_Scheduler, EventFactory.createLoopWarningEventGen(slidingWindowId
                    , loopId
                    , runId
            ), slidingWindowId);
        }
