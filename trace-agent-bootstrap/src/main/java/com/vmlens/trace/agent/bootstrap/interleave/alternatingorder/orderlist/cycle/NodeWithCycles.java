...
import com.vmlens.trace.agent.bootstrap.interleave.alternatingorder.orderlist.NextNodeAndProcessFlag;
import com.vmlens.trace.agent.bootstrap.interleave.alternatingorder.orderlist.OrderAlternative;
import com.vmlens.trace.agent.bootstrap.interleave.alternatingorder.orderlist.OrderListNode;

import java.util.Iterator;

public abstract class NodeWithCycles implements ForEachApply , OrderListNode {
    ...
    protected abstract OrderListNode nextForAddOrder();
