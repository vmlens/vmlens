...
public class RunMethodEnterExitStrategy implements MethodEnterExitStrategy {
    ...
    public void onMethodEnter(Object object,
        ...
        if (checkIsThreadRun.isThreadRun()) {
            threadLocalWhenInTestAdapter.process(new CallbackActionThreadRunEnter(
                    new RunnableOrThreadWrapper(Thread.currentThread()), threadLocalForParallelizeProvider
