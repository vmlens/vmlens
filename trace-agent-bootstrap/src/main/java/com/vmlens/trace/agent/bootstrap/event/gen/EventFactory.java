...
public static RuntimeEvent createStateEventFieldGen ( int slidingWindowId
,  long     threadId
,  int     classId
,  int     methodId
,  int     methodCounter
...
public static RuntimeEvent createStateEventFieldInitialGen ( int slidingWindowId
...
return new StateEventFieldInitialGen(
   slidingWindowId
,  threadIdAtEvent
,  classId
,  methodId
...
public static RuntimeEvent createStateEventStaticFieldGen ( int slidingWindowId
,  long     threadId
,  int     fieldId
,  int     methodId
,  int     methodCounter
...
return new StateEventStaticFieldGen(
   slidingWindowId
,  threadId
,  fieldId
,  methodId
...
public static RuntimeEvent createStateEventStaticFieldInitialGen ( int slidingWindowId
,  long     threadIdAtEvent
,  int     fieldId
,  int     methodId
,  int     methodCounter
...
return new StateEventStaticFieldInitialGen(
   slidingWindowId
,  threadIdAtEvent
,  fieldId
,  methodId
...
public static RuntimeEvent createStateEventArrayGen ( int slidingWindowId
,  long     threadId
,  int     methodId
,  int     position
,  int     methodCounter
