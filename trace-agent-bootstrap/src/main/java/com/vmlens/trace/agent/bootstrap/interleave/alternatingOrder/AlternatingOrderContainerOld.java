...
public class AlternatingOrderContainerOld implements Iterable<CalculatedRunOld> {

    final Logger logger;
    final TLinkableWrapper<AlternatingOrderElementOld>[] optionalAlternatingOrderElements;
    final TLinkableWrapper<LeftBeforeRightOld>[] fixedOrders;
    final int[] length;

    static void sort(TLinkableWrapper<AlternatingOrderElementOld>[] unsorted) {
        Arrays.sort(unsorted, new AlternatingOrderElementComparator());
    }

    static void sortFixed(TLinkableWrapper<LeftBeforeRightOld>[] unsorted) {
        Arrays.sort(unsorted, new TLinkableWrapperLeftBeforeRightComparator());
    }

    public AlternatingOrderContainerOld(Logger logger, FixedAndAlternatingOrder fixedAndAlternatingOrder,
                                        int[] length) {
    ...
    public AlternatingOrderContainerIteratorOld iterator() {
        return new AlternatingOrderContainerIteratorOld(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        AlternatingOrderContainerOld that = (AlternatingOrderContainerOld) o;
    ...
    public String toString() {
        ...
        String result = "";
        for (TLinkableWrapper<LeftBeforeRightOld> element : fixedOrders) {
            if (!isFirst) {
                result += ",\n";
            }
            isFirst = false;
        ...
        for (TLinkableWrapper<AlternatingOrderElementOld> element : optionalAlternatingOrderElements) {
            if (!isFirst) {
                result += ",\n";
            }
            isFirst = false;
