package com.vmlens.trace.agent.bootstrap.callback.inttest.util;
...
public class RunForCallbackMock implements RunForCallback {
    ...
    @Override
    public  TLinkedList<TLinkableWrapper<SerializableEvent>> after(RuntimeEvent runtimeEvent,
                                         ThreadLocalWhenInTest threadLocalDataWhenInTest) {
        runActions.add(new After(runtimeEvent));
        return singleton(runtimeEvent);
    }

    @Override
    public TLinkedList<TLinkableWrapper<SerializableEvent>> endAtomicAction(RuntimeEvent runtimeEvent,
                                                   ThreadLocalWhenInTest threadLocalDataWhenInTest) {
    ...
    @Override
    public TLinkedList<TLinkableWrapper<SerializableEvent>> startAtomicActionWithNewThread(ThreadLocalWhenInTestForParallelize threadLocalDataWhenInTest,
