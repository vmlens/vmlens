...
public class AgentApiCallbackImplIntegTest {
    ...
    public void newRun() {
        ...
        WhileLoopNameEvent expectedWhileLoopNameEvent = new WhileLoopNameEvent(0, givenName);
