package com.anarsoft.trace.agent.runtime.classtransformerall.callbackfactory;
...
public class MethodCallbackFactory {
    ...
    public void beforeMethodCall(int calledMethodId) {
        methodCall(calledMethodId, BEFORE_METHOD_CALL, METHOD_DESCRIPTOR_INT_ARGUMENT);
    }
