...
public class ClassFilterDeprecated {
    ...
    public static ClassFilterDeprecated create(Properties properties) {
        ...
        return new ClassFilterDeprecated(alwaysTake, filter);
    }
