...
public class FactoryMethodTransformerMethodEnterObjectArg implements  FactoryMethodTransformer
{
	...
	public FactoryMethodTransformerMethodEnterObjectArg(String callbackClass,
	...
	private  final class MethodTransformerTraceMethodEnter extends MethodVisitor implements Opcodes  {
		...
		private void onMethodEnter() {
			...
			mv.visitMethodInsn(INVOKESTATIC, callbackClass, callbackMethod , "(Ljava/lang/Object;Ljava/lang/Object;)V");
		}
