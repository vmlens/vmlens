...
import com.anarsoft.trace.agent.preanalyzed.serialize.SerializePackageOrClass;
...
public class ModelFactory {
    ...
    public static void main(String[] args) throws IOException {
        FileOutputStream fileOutputStream = new FileOutputStream("C:/git-repo/vmlens/agent-runtime/preanalyzed.vmlens");
        DataOutputStream dataOutputStream = new DataOutputStream(fileOutputStream);
        TLinkedList<TLinkableWrapper<PackageOrClass>> list = new ModelFactory().create();
        new SerializePackageOrClass().serialize(list, dataOutputStream);
    ...
    public TLinkedList<TLinkableWrapper<PackageOrClass>> create() {
        ...
        */
        ...
        result.add(wrap(new PackageOrClass("java/lang/Thread$", ClassTypeAllStartWith.SINGLETON, new PreAnalyzedMethod[0])));
        result.add(wrap(new PackageOrClass("java/lang/Thread", ClassTypeFilter.SINGLETON, new PreAnalyzedMethod[0])));
