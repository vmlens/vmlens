...
public interface PreAnalyzedStrategy {

    void addMethodCallToResult(FactoryForPreAnalyzedAndAll factory,
    ...
    void addCallback(NameAndDescriptor nameAndDescriptor, CallbackInNonBlockingMethod[] callbackMethods);
}
