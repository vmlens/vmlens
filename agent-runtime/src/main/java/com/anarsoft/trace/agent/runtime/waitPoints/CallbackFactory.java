...
import com.vmlens.shaded.gnu.trove.procedure.TIntProcedure;
...
public class CallbackFactory implements Opcodes {
	...
	//public static final String CALLBACK_CLASS_WAITPOINT_ACCESS = "com/vmlens/trace/agent/bootstrap/callback/WaitPointCallback";
	...
	public void createCallbackForFieldWrite(String owner, String fieldName, MethodVisitor mv, FieldIdAndTyp typAndId,
				...
				boolean isWrite)
		{
			...
			if(  typAndId.fieldTyp == FieldTyp.UNDEFINED   )
			{
				...
				// System.out.println( typAndId.id  );
