...
public class AnalyzeMethod implements AnalyzeOrTransformMethod {

    private final MethodTransformPlanBuilder methodTransformPlan;

    private final CallStack<StackElement> callStack = new StackImpl<>();

    public AnalyzeMethod(MethodTransformPlanBuilder methodTransformPlan) {
    ...
    public static MethodVisitor asMethodVisitor(MethodCallIdMap methodCallIdMap,
        ...
        return new MethodVisitorAdapter(null, methodCallIdMap, new AnalyzeMethod(methodTransformPlan));
    }
