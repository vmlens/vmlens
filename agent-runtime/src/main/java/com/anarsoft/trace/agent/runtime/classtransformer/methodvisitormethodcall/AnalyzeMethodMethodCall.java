...
public class AnalyzeMethodMethodCall implements AnalyzeOrTransformMethodMethodCall {
    ...
    public static MethodVisitor asMethodVisitor(MethodVisitor previous,
                                                MethodCallIdMap methodCallIdMap,
                                                MethodTransformPlanBuilder methodTransformPlan) {
        return new MethodVisitorAdapter(previous, methodCallIdMap, new AnalyzeMethodMethodCall(methodTransformPlan));
    }
